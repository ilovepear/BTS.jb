...
- Salle de formation équipée de 15 postes informatiques
- Vidéoprojecteur
- Tableau interactif
...
- Formation à dispenser sans perturber l'activité quotidienne
- Groupes hétérogènes en termes de compétences numériques
- Nécessité d'adapter le contenu aux différents départements

**Logiciel :**

- TryRiot (plateforme de simulation de phishing + formation utilisateurs)
- Notion (gestion de connaissances et collaboration)
...
- Maîtrise des outils à présenter
- Connaissance des menaces cybersécurité actuelles
### Difficultés rencontrées
- Résistance au changement de certains utilisateurs
- Disparité des niveaux de compétence numérique
- Planification complexe pour toucher l'ensemble des collaborateurs
- Adaptation du contenu aux spécificités de chaque département
### Durée de réalisation
12 semaines pour la conception, le déploiement et l'évaluation initiale
## Solutions envisageables
1. Formation présentielle exclusive avec sessions dédiées par thématique
1. Formation entièrement en ligne via plateforme e-learning
1. Approche hybride combinant présentiel et ressources numériques
1. Formation par les pairs avec désignation d'ambassadeurs par équipe
1. Programme progressif avec certification interne
## Solution retenue
Approche hybride associant sessions présentielles ciblées et ressources en ligne accessibles en continu, complétée par des exercices pratiques et des simulations régulières de phishing.
### Conditions initiales
Programme de formation à créer intégralement, avec prise en compte des besoins spécifiques identifiés lors d'un audit préalable et alignement sur la politique de sécurité de l'entreprise.
### Résultat final
...
Pour renforcer l'impact de cette sensibilisation, j'ai développé plusieurs supports :
...
Les sessions de formation Dashlane incluent systématiquement des exercices pratiques où chaque participant :
...
Le module Slack s'articule autour de quatre axes :
...
À titre d'exemple, l'analyse des premiers résultats a conduit à plusieurs ajustements :
